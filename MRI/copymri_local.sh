...
script_dir="/autofs/cluster/transcend/scripts/MRI"
...
mri_dir=/autofs/cluster/transcend/MRI/WMA
ping_mri_dir=/autofs/space/cluster/transcend/MRI/ping
...
echo -n " Running Reconn Locally ... "
${script_dir}/do_wma_fsrecon.csh ${trpsubj} ${type} ${mri_dir} ${run}
 echo "done"
