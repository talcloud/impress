...
# Script :do_wma_fsreconsantosh.csh
...
set script_dir=/space/calvin/1/marvin/1/users/MRI/scripts
...
set mprage=`grep -e 'MPRAGE_160sl_7deg.*  ok  256 256 160' ${unpack_dir}/${subj}_unpack.log | awk '{print $8}'`
...
recon-all -subject ${subj} ${infiles} -autorecon-all -noaseg -qcache -no-isrunning |& tee ${SUBJECTS_DIR}/log/fsrecon/${subj}_fsrecon.log
if ( $? ) then
