...
if size(good_epochs)~=0,
 ...
 all_epochs=0;
                  ...
                  save(strcat(cfg.data_rootdir,'/','epochMEG','/',subj,'_',cfg.protocol,'_VISIT_',num2str(visitNo),'_cond_',num2str(cond), '_',num2str(cfg.epochMEG_filt.hpf(iepochMEG_filter)),'-',num2str(cfg.epochMEG_filt.lpf(iepochMEG_filter)),'fil_epochs.mat'),'run','cond','good_epochs','all_epochs','cfg','visitNo');
