function [cfg]=do_mne_preproc_grand_average_debug1(subj,visitNo,run,cfg)
%% Global Variables
...
% cfg.mne_preproc_grand_average=cfg.mne_preproc_filt;
    ...
    if ~isfield(cfg,'mne_preproc_grand_average')
