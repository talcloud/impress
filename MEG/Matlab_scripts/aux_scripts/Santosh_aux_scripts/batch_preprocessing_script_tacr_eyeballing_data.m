...
% Data Directory
cfg.data_rootdir=('/autofs/cluster/transcend/MEG/tacr_new');
...
subject={'AC013';'042201';'042301';'051301';'009101';'007501';'038301';'038502';'051901';'AC003';'AC023';'AC046';'AC047';'AC056';'AC058';'AC061';'AC076';'014002';'014001'};
...
cfg.single_subject=[];
        ...
        % If multiple dimensions, must match length(cfg.amp_sub_folders) 
        %visitNo=[1];
        visitNo=[ones(17,1);2;2;2;2;2;2;2;2];
