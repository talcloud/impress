...
% .Ave file for Protocol
 cfg.protocol_covdir = ('/autofs/cluster/transcend/distractor');

% Data Directory
cfg.data_rootdir=('/autofs/cluster/transcend/distractor');
...
%                 cfg.do_sss_decimation_combined_mne=[];
...
%  wmm   
% subject={'005801','007501','009101','009102','009901','012002','012301','013703','015001','027202','011202','010302','010302','008801','014001','014002','014901','015601','030801','055201','007501','026801','AC017','AC019','AC021','046503','018201','005901','011302','016201','017801','021301'};
subject={'043202'};
...
cfg.single_subject=[];
        ...
        % runs of the data to be processed. If different for different subjects, can be a matrix
         % If multiple dimensions, must match length(cfg.amp_sub_folders)
%        run=[1;1;1;1;1;1;1;1];
%          run=[2;2;2;2;2;2;2;2;2;2;2;ones(55,1)];
run=2;
%                  run=[2;1;1;2];
         %run=[3,3];
        % visitNo of each of the subject(s). if multiple, can be a matrix
        % If multiple dimensions, must match length(cfg.amp_sub_folders) 
        visitNo=[ones(55,1);2;2;2;2;2;2;2;2];
