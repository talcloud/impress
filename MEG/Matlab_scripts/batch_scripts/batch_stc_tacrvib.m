...
set=[2];
for t=1
command = ['mne_make_movie  --subject ' subject{i}  ' --inv  ' subject{i},'_tacrvib_0.1_144_fil_loose_new_erm_megreg_0_new_MNE_proj-inv.fif'...
    ' --meas   ' ,subject{i},'_tacrvib_1_0.1_144fil-merge-ave.fif  ', ' --smooth 5  '...
