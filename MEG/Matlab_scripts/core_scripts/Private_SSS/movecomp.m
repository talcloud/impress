...
%%% added by konmic - Oct 1, 2014
% check whether we have a good HPI fit 
% if sum(strcmp(alllines,HPIline)) == 0
%     fprintf('movecomp: HPI fit is not OK - cannot plot maxfilter output from log-file')
% end
