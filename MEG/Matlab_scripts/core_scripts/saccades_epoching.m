...
new_in_fif_File=strcat(cfg.data_rootdir,'/', subj,'/', subj,'_',cfg.protocol,'_',num2str(irun),'_20fil_raw.fif');
...
elseif irun==2,
 ...
 eogenter=eog3;
                ...
                fileData=strcat(cfg.data_rootdir,'/', subj,'/', subj,'_',cfg.protocol,'_',num2str(irun),'_20fil_raw.fif');
                A=exist(fileData);
                ...
                goodtrialLog=strcat(cfg.data_rootdir,'/', subj,'/', subj,'_',cfg.protocol,'_',num2str(irun),'_ecgClean-20fil-ave.log'); 
...
if size(good_epochs)~=0,
 ...
 all_epochs=0;
                  ...
                  save(strcat(cfg.data_rootdir,'epochMEG-saccades','/',subj,'_',cfg.protocol,'_cond_',num2str(cond),'_run_',num2str(irun),'_ecgClean-20fil_epochs.mat'),'run','cond','good_epochs','all_epochs','cfg','goodtrialLog','eventfile');
