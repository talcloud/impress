...
%%
low_event1=zeros(size(low_filter,1),size(low_filter,2),1200,length(event1),'single');

for i=1:length(event1)

    low_event1(:,:,:,i)=single(low_filter(:,:,event1(i):event1(i)+1199));
...
low_event2=zeros(size(low_filter,1),size(low_filter,2),1200,length(event2),'single');

for i=1:length(event2)

    low_event2(:,:,:,i)=single(low_filter(:,:,event2(i):event2(i)+1199));

end


low_event3=zeros(size(low_filter,1),size(low_filter,2),1200,length(event3),'single');

for i=1:length(event3)

    low_event3(:,:,:,i)=single(low_filter(:,:,event3(i):event3(i)+1199));

end


%%
hi_event1=zeros(size(hi_filter,1),size(hi_filter,2),1200,length(event1),'single');

for i=1:length(event1)

    hi_event1(:,:,:,i)=single(hi_filter(:,:,event1(i):event1(i)+1199));
...
hi_event2=zeros(size(hi_filter,1),size(hi_filter,2),1200,length(event2),'single');

for i=1:length(event2)

    hi_event2(:,:,:,i)=single(hi_filter(:,:,event2(i):event2(i)+1199));

end


hi_event3=zeros(size(hi_filter,1),size(hi_filter,2),1200,length(event3),'single');

for i=1:length(event3)

    hi_event3(:,:,:,i)=single(hi_filter(:,:,event3(i):event3(i)+1199));
