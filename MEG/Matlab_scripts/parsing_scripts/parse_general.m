function [infoCell,unique_subjects]=parse_general(logfile,protocol)
...
%             continue
%             end
             infoCell{counter,3}=fileName;
             infoCell{counter,4}=date;
             counter=counter+1;
...
unique_subjects{1,4}=infoCell{1,4};
temp=1;
for i=2:length(infoCell),
    ...
    if(r==0),
        ...
        unique_subjects{temp,1}=infoCell{i,1};
         ...
         unique_subjects{temp,4}=infoCell{i,4};
